...
* Every team has its progressives. If they're empowered, they foster
change. If they're disempowered, they're still eager to take part in change.

* Middle managers account for costs and apologise for slippage. They're used
to that. Telling them to account for ROI and taking away their apologetic
method causes the infamous [Frozen Middle]() anti-pattern.

* Taking a team, program or organization part-way Agile offers questionable
...
Instead, create a new cross-functional end-to-end feature based Agile
capability uncompromised by existing ways of working.

Staff it with progressives And grow it with the support of a coordination
scrum of lead doers from the old organisation with the blessing of senior
management.

Let it leverage the quickest dirtiest deployment pathway but make it
accountable for its own quality.

Add product owners focused on maximising ROI per release rather than
minimising variance to baseline.

Put in place bottom-line metrics to demonstrate that the throughput, quality
and ROI of the new capability exceeds the performance of the old.
...
The Goose in the Bottle is what the Japanese Zen tradition calls a _koan_, a
kind of riddle for personal transformation. It's not supposed to have a
rational answer. 

Solving it is supposed to take sweat. You may have to travel. Consult wise
...
walk into trouble, or else you won't be there in the first place. 

Per the [seven samurai](http://agiletng.org/2014/03/21/the-seven-samurai/) I
...
times in a week according to my diary.  
...
That was the bottle, and I was the goose. 
...
maximising ROI in the backlog rather than minimising variance to baseline.
...
That's how I coached. Over the course of a year that first gosling grew
...
its projects Agile. I didn't use the [seven
samurai](http://agiletng.org/2014/03/21/the-seven-samurai/) then, just got
stuck in and went for it.
...
It wasn't all me of course - the team members were all-stars. And it was never
...
its business unit, and then throughout the bank.

Sorry, but I can't resist talking about the waterfowl method here ...
comparing Agile in the bank with Aesop's [ugly
duckling](http://hca.gilead.org.il/ugly_duc.html) who grew up ...  and then
everyone saw it as a beautiful swan ...
...
its head out. Our goose was always a metaphor. 
