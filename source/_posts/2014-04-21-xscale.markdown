...
eXcellence
: Linking the manifesto to _Beck's Maxim_: Turn all the knobs to ten.

Scale-symmetry
: Map distinctions breadth-first to control combinations.

Continuous
: Minimum practical cycle time and batch size.
...
* ([DRY]())s code into distinct modules to group common behaviours
